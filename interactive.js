    ...
    drawer.innerHTML = `
      <div class="mobile-drawer-inner">
        ...
        <nav class="mobile-nav">
          <a href="https://www.knowyourproducts.in/eternofashion-index.html" class="mobile-nav-link">🏠 Home</a>
          <a href="https://www.knowyourproducts.in/eternofashion-shop.html" class="mobile-nav-link">🛍️ Shop</a>
          <a href="https://www.knowyourproducts.in/eternofashion-cart.html" class="mobile-nav-link">🛒 Cart</a>
          <a href="https://www.knowyourproducts.in/eternofashion-login.html#signin" class="mobile-nav-link">🔓 Sign In</a>
          <a href="https://www.knowyourproducts.in/eternofashion-login.html#signup" class="mobile-nav-link">✨ Create Account</a>
        </nav>
      </div>
    `;
  ...
  modal.innerHTML = `
    <div class="quickview-card" id="quickViewCard">
      ...
      <div class="quickview-info">
        ...
        <a href="https://www.knowyourproducts.in/eternofashion-shop.html" class="btn btn-outline btn-sm" style="width:100%;justify-content:center;margin-top:10px;">
          View All Items
        </a>
      </div>
    </div>
